...
2. Describe your design, reasoning, or code structure in the submission box.
3. Click Verify. The website will return structured feedback.

## About

Part of an undergraduate research study at Virginia Tech on LLM-based
verification of course concepts. It currently focuses on ECE 2514, with plans to implement functionality for other ECE courses.

This project is still currently being updated, so expect for major changes to take place.